...
| R5  | **Malayalam full-text search.** FTS5's default tokeniser may handle Malayalam poorly                                                                          | Text search unusable — half of R2             | Experiment against the real corpus early; custom tokeniser as fallback                                                                               |
